...
public partial class LabCalculatorBaseListener : ILabCalculatorListener {
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>DivModExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterDivModExpr([NotNull] LabCalculatorParser.DivModExprContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>DivModExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitDivModExpr([NotNull] LabCalculatorParser.DivModExprContext context) { }
